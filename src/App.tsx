    ...
    <div className="flex items-center justify-center min-h-screen text-slate-800 bg-zinc-700">
      <div className="w-full max-w-lg px-4 py-10 my-10 bg-white rounded-lg shadow-2xl">
        ...
        <div className="">
          ...
          >
            {songs.map((song) => (
              <Reorder.Item as='div' value={song} key={song.id} className="flex items-center w-full gap-6 p-4 mx-auto mb-4 card ">
                ...
                <img src={song.image} alt="" className="w-14 hue-rotate-30 pointer-events-none"  />
